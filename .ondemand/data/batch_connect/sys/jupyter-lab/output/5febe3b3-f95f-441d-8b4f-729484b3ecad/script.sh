...
case "${TOOLCHAIN}" in
  2021a )
    ...
    [[ "${LOAD_MATPLOTLIB}" == 'yes' ]] && module load matplotlib/3.4.2-foss-2021a ipympl/0.9.3-foss-2022a
    ;;
  2022a )
    module load JupyterLab/3.5.0-GCCcore-11.3.0
    [[ "${LOAD_SCIPY}" == 'yes' ]] && module load SciPy-bundle/2022.05-foss-2022a
    [[ "${LOAD_MATPLOTLIB}" == 'yes' ]] && module load matplotlib/3.5.2-foss-2021a ipympl/0.9.3-foss-2022a
    ;;
  2023a )
